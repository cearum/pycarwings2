...
'''
        {
                'status': 200, 
                'receivedDate': 'Nov 18, 2017 02:58 PM', 
                'lng': '-83.531836111111',
                'lat': '42.528544444444', 
                'TargetDate': '2017/11/18 14:58'
        }

'''

class CarwingsLocationResponse(CarwingsResponse):
	def __init__(self, status):
		#CarwingsResponse.__init__(self, status)
		
		self.latitude = status["lat"]
		self.longitude = status["lng"]
		self.receivedDate = status["receivedDate"]

'''
('Lat Long Result Key: ', u'keygoeshere')
('Status Lat Long Result: ', 
        {
                'status': 200, 
                'timeStamp': '2017-11-18 14:58:26', 
                'responseFlag': '1', 
                'Location': {
                        'LongitudeMin': '12', 
                        'LatitudeDeg': '12', 
                ...
                'lng': '-12.3456781234567',
                'receivedDate': u'2017/11/18 14:58', 
                'lat': u'12.345678123456', 
                'resultCode': '1', 
                'TargetDate': u'2017/11/18 14:58'
        })
'''
class CarwingsLocationStatusResponse(CarwingsResponse):
	def __init__(self, status):
		#CarwingsResponse.__init__(self, status)
